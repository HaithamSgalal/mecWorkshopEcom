...
<!---header--->
<div class="w3-container w3-section header-photo  w3-grayscale-min " id="home" >
    <div class="w3-display-left w3-text-white" style="padding:48px">
        <span class="w3-jumbo w3-hide-small" style="font-family: 'Libre Baskerville', serif;"><i>All The Prouducts You Wish</i></span><br>
        <span class="w3-xxlarge w3-hide-large w3-hide-medium"></span><br>
        <span class="w3-large" style="font-family: 'Libre Baskerville', serif;"><i>Are Now Available With Us At Best prices & Discounts </i></span>
        <p><a href="#about" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Check Out Our New Deals</a></p>
    </div>
